            ...
            <?php if($direkturUtama): ?>
                <div class="flex justify-center mb-8">
                    <div class="flex flex-col items-center">
                        <img src="<?php echo e(asset('storage/' . $direkturUtama->foto)); ?>" alt="Foto <?php echo e($direkturUtama->nama); ?>" class="w-32 h-32 rounded-full mb-2 object-cover">
                    ...
                    <?php if($kepalaDepartemen || $sekretarisDepartemen): ?>
                        <div class="flex justify-center gap-12 mb-6">
                            <?php if($kepalaDepartemen): ?>
                                <div class="flex flex-col items-center">
                                    <img src="<?php echo e(asset('storage/' . $kepalaDepartemen->foto)); ?>" alt="Foto <?php echo e($kepalaDepartemen->nama); ?>" class="w-24 h-24 rounded-full mb-2 object-cover">
                            ...
                            <?php if($sekretarisDepartemen): ?>
                                <div class="flex flex-col items-center">
                                    <img src="<?php echo e(asset('storage/' . $sekretarisDepartemen->foto)); ?>" alt="Foto <?php echo e($sekretarisDepartemen->nama); ?>" class="w-24 h-24 rounded-full mb-2 object-cover">
                        ...
                        <div class="mb-6">
                            ...
                            <?php if($kepalaDivisi): ?>
                                <div class="flex flex-col items-center mb-4">
                                    <img src="<?php echo e(asset('storage/' . $kepalaDivisi->foto)); ?>" alt="Foto <?php echo e($kepalaDivisi->nama); ?>" class="w-20 h-20 rounded-full mb-2 object-cover">
                                ...
                                <?php $__currentLoopData = $anggotas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $anggota): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(!in_array($anggota->jabatan, ['Kepala Departemen', 'Sekretaris Departemen', 'Kepala Divisi'])): ?>
                                        <div class="bg-white p-4 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
                                            <img src="<?php echo e(asset('storage/' . $anggota->foto)); ?>" alt="Foto <?php echo e($anggota->nama); ?>" class="w-24 h-24 rounded-full mx-auto mb-4 object-cover">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\WEB-HMTI\resources\views/anggota/index.blade.php ENDPATH**/ ?>