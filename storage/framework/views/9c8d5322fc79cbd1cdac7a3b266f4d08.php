        ...
        <div class="max-w-6xl mx-auto px-4">
            ...
            <?php if($news->count() > 0): ?>
                <div class="text-center mt-8">
                    <a href="<?php echo e(route('public.news.index')); ?>" class="inline-flex items-center px-5 py-2 bg-indigo-900 text-white text-sm rounded-full hover:bg-purple-800 transition-all duration-300 flex items-center justify-center">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\WEB-HMTI\resources\views/dashboard.blade.php ENDPATH**/ ?>