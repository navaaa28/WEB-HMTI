                        ...
                        <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 flex flex-col h-full mx-2 md:mx-0">
                            ...
                            <div class="p-4 md:p-6 flex flex-col flex-grow">
                                ...
                                <?php if($event->registration_open): ?>
                                    <a href="<?php echo e(route('events.show', $event->id)); ?>" class="bg-indigo-900 text-white px-3 md:px-4 py-1 md:py-2 rounded mt-2 md:mt-4 text-center hover:bg-purple-800 transition duration-300">
                                        Lihat Detail
                                    </a>
                                <?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\himpunan-ticketing\resources\views/welcome.blade.php ENDPATH**/ ?>