...
<section id="struktur" class="bg-gray-50 py-16" data-aos="fade-up">
    ...
    <div class="fixed bottom-4 right-4 z-50">
        <a href="{{ route('aspirasi.create') }}" class="bg-indigo-900 text-white px-6 py-3 rounded-full shadow-lg hover:bg-purple-800 transition duration-300 flex items-center space-x-2">
