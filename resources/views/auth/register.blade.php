...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-blue-100 to-blue-200 py-24 px-4 sm:px-6 lg:px-8">
    <div class="w-full max-w-md" x-data="{ password: '', strength: 0, message: '', showPassword: false, loading: false }">
        ...
        <div class="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl border border-blue-100 p-8 space-y-8 transition-all duration-300 hover:shadow-2xl transform hover:-translate-y-1">
            ...
            <div class="text-center">
                ...
                <h1 class="text-3xl font-bold bg-gradient-to-r from-blue-900 to-blue-700 bg-clip-text text-transparent font-serif animate-fade-in">Create Account</h1>
                <p class="text-gray-600 mt-2 text-sm">Teknik Industri Universitas Teknologi Bandung</p>
            </div>

            <form method="POST" action="{{ route('register') }}" class="mt-8 space-y-4" @submit="loading = true">
                @csrf
                <!-- Name Input -->
                <div class="space-y-1">
                    ...
                    <div class="relative group">
                        ...
                        <input type="text" name="name" required value="{{ old('name') }}"
                               class="block w-full pl-10 pr-4 py-3 border-2 border-blue-100 rounded-xl focus:ring-2 focus:ring-blue-200 focus:border-blue-400 transition-all duration-200 bg-white/70 backdrop-blur-sm @error('name') border-red-300 focus:border-red-400 focus:ring-red-200 @enderror"
                ...
                <div class="space-y-1">
                    ...
                    <div class="relative group">
                        ...
                        <input type="email" name="email" required value="{{ old('email') }}"
                               class="block w-full pl-10 pr-4 py-3 border-2 border-blue-100 rounded-xl focus:ring-2 focus:ring-blue-200 focus:border-blue-400 transition-all duration-200 bg-white/70 backdrop-blur-sm @error('email') border-red-300 focus:border-red-400 focus:ring-red-200 @enderror"
