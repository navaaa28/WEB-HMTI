                ...
                <div class="flex justify-between items-center h-16 md:h-20">
                    ...
                    <div class="hidden md:flex items-center space-x-4 lg:space-x-6">
                        @guest
                            ...
                            <a href="{{ route('register') }}" class="px-4 lg:px-6 py-2 lg:py-2.5 bg-gradient-to-r from-blue-900 to-blue-700 text-white rounded-full hover:shadow-lg hover:scale-105 transition-all duration-300 text-sm lg:text-base font-medium">
                                Daftar
                            </a>
                        @else
                            ...
                            <a href="{{ route('registrations.index') }}" class="px-2 lg:px-3 py-2 text-sm lg:text-base text-gray-700 hover:text-blue-900 font-medium transition-all relative after:absolute after:bottom-0 after:left-0 after:h-0.5 after:w-0 hover:after:w-full after:bg-blue-900 after:transition-all {{ request()->routeIs('registrations.*') ? 'text-blue-900 after:w-full' : '' }}">
                                Registrasi Saya
                            </a>
                            ...
                            <div class="relative" x-data="{ openDropdown: false }">
                                <button @click="openDropdown = !openDropdown" class="flex items-center space-x-2 group px-3 lg:px-4 py-1.5 lg:py-2 rounded-full border border-gray-200 hover:border-blue-200 transition-all">
                                    <span class="text-gray-700 group-hover:text-blue-900 text-sm lg:text-base font-medium truncate max-w-[120px] lg:max-w-[150px]">{{ Auth::user()->name }}</span>
