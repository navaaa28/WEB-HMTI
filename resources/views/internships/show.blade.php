...
<div class="pt-20 md:pt-28 overflow-visible relative">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Back Button -->
        <div class="mb-6">
            <a href="{{ route('public.internships') }}" class="inline-flex items-center text-sm font-medium text-gray-600 hover:text-blue-600 transition-colors">
                    ...
                    <div class="relative -mt-16 flex items-end">
                        <div class="bg-white p-4 rounded-lg shadow-md inline-block">
                            <div class="w-24 h-24 flex items-center justify-center bg-gray-100 rounded-lg">
                                <span class="text-2xl font-bold text-blue-800">{{ substr($internship->company, 0, 2) }}</span>
                            </div>
                        </div>
                        <div class="ml-6 pb-4">
                            <h1 class="text-3xl font-bold text-gray-900">{{ $internship->title }}</h1>
                            <div class="mt-1">
                                <h2 class="text-xl font-semibold text-gray-800">{{ $internship->company }}</h2>
            ...
            <div class="px-6 sm:px-8 py-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
                    <div class="bg-blue-50 rounded-lg p-5 border border-blue-100">
                        ...
                        <p class="text-gray-700 font-medium">{{ $internship->start_date->format('d M Y') }} - {{ $internship->end_date->format('d M Y') }}</p>
                    </div>
                    <div class="bg-red-50 rounded-lg p-5 border border-red-100">
                        ...
                        <p class="text-gray-700 font-medium">{{ $internship->deadline->format('d M Y') }}</p>
                    </div>
                </div>
                ...
                <!-- Benefits Section -->
                <div class="mb-10">
                    <h3 class="text-xl font-semibold text-gray-800 mb-4 pb-2 border-b">Manfaat</h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-800 font-medium">{{ $internship->contact_person }}</p>
                            </div>
                        </div>
                        <div class="flex items-start">
                            <div class="bg-white p-3 rounded-full shadow-sm mr-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-800 font-medium">{{ $internship->contact_email }}</p>
                            </div>
                        </div>
                        <div class="flex items-start">
                            <div class="bg-white p-3 rounded-full shadow-sm mr-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-800 font-medium">{{ $internship->contact_phone }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                @if($internship->apply_url)
                    <div class="text-center py-6">
                        ...
                        <p class="mt-3 text-gray-500">Pendaftaran ditutup pada {{ $internship->deadline->format('d M Y') }}</p>
                    </div>
                @endif
            </div>
        </div>
